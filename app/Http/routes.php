...
Route::group(['middleware' => ['web']], function () {
	...
	// Route::post('user/getData', 'UserController@postGetData');
	Route::post('user/postGetData', 'HomeController@postGetData');
	// Route::post('user/getData', function(){
	// 	// ChromePhp::log("arg");
	// 	echo "asdfasdfasdf";
	// });
	...
	Route::get('auth/success', 'HomeController@dataTable_view');
	Route::post('auth/success', 'HomeController@dataTable_view');
